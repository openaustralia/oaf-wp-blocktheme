...
<div class="wp-block-group alignfull oaf-band has-sand-background-color has-background">
	...
	<div class="oaf-ct">
		<div class="oaf-sechead">
			...
			<span class="oaf-sechead__link"><a class="oaf-morelink" href="/collection/">Browse the catalogue &rarr;</a></span>
		</div>
		<p class="oaf-intro">Our free public services - the shelves of our digital library. Built and maintained by our small team and the invaluable contribution of many volunteers.</p>
		<div class="oaf-coll-list">
			...
			<div class="oaf-service-card"><a class="oaf-coll-row" href="/collection/"><span class="oaf-coll-band" style="background:#00dcf0"><img src="<?php echo esc_url( $oaf_svc . '/rtk-logo.svg' ); ?>" alt="Right to Know"></span><span class="oaf-coll-row__one">Make Freedom of Information requests, publicly archived.</span><span class="oaf-coll-row__stat" style="color:#007a85"><?php echo oaf_stat( 'visible_request_count', '12,346' ); ?> FOI requests archived</span></a></div>
			...
			<div class="oaf-service-card"><a class="oaf-coll-row" href="/collection/"><span class="oaf-coll-band" style="background:#f4f1eb"><img src="<?php echo esc_url( $oaf_svc . '/oa-logo.png' ); ?>" alt="OpenAustralia"></span><span class="oaf-coll-row__one">Hansard, made findable. Searchable transcripts of Australian Federal Parliament.</span><span class="oaf-coll-row__stat" style="color:#3a4e72">Every word since 2006</span></a></div>
		</div>
	</div>
	<!-- /wp:html -->
</div>
